    ...
    <div class="tab-content rental-tab provision-lab">
        <div class="proc-header">
            <div class="proc-title">
                <h3>LEASING_&_RENTAL_MGMT</h3>
                <p>Verwaltung der Mietverhältnisse und Billing-Zyklen für diese Einheit.</p>
            </div>
        </div>
        ...
        <div v-if="server.tenantId" class="v3-rental-status">
            <div class="v3-info-box blue">
                ...
                <div class="v3-spec-grid">
                    ...
                    <div class="v3-spec"><span>Vertrags-ID</span> <strong class="mono">#RENT-{{ server.id.substring(0,6) }}</strong></div>
                </div>
            ...
            <div class="v3-rental-form">
                <div class="v3-info-box warning">
                    ...
                    <div class="info-group">
                        <p class="setting-desc">List this hardware on the global exchange to earn passive rental income.</p>
                        ...
                        <div v-else>
                            <div class="form-group" style="margin-bottom: 20px;">
                                ...
                                <input type="number" v-model="localPrice" step="0.01" class="v3-input" placeholder="0.00">
                                <small class="hint">Recommended: ${{ (server.purchaseCost / 1000).toFixed(2) }} - ${{ (server.purchaseCost / 500).toFixed(2) }} /h</small>
                            </div>
                            
                            <button @click="handleList" :disabled="processing || !localPrice" class="btn-primary-v3 w-100">
...
const terminateRental = async () => {
    ...
    if (!confirm('Sind Sie sicher, dass Sie diesen Vertrag kündigen wollen?')) return;
