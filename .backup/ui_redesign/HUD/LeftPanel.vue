    ...
    <aside class="left-panel">
        ...
        <div class="panel-content">
            ...
            <div class="panel-section">
                ...
                <div class="room-list">
                    <template v-for="room in roomList" :key="room?.id || Math.random()">
                        <button 
                            v-if="room"
                            class="room-item"
                            :class="{ 
                        ...
                        >
                            ...
                            <div class="room-item__info">
                                <div class="room-item__name">
                                    <span v-if="getRegionFlag(room.region)" class="region-pill">{{ getRegionFlag(room.region) }}</span>
                                    {{ room.name }}
                                </div>
                            ...
                            <div class="room-item__indicators">
                                ...
                                <div v-if="room.warnings?.powerOutage" class="indicator indicator--danger" title="Power Outage - Cooling Offline">
                                    🔌
                                </div>
            ...
            <div class="panel-section">
                ...
                <div class="action-grid">
                     ...
                     <button class="action-btn" @click="$emit('openSpecialization')">
                        <span class="action-icon">🏢</span>
                        <span>Strategy</span>
                     </button>
                     <button class="action-btn" @click="$emit('openSandbox')">
                        <span class="action-icon">🧪</span>
            ...
            <div class="panel-section">
                ...
                <div class="order-list">
                    <div 
                        ...
                        :class="{ 'order-item--urgent': (order.patience?.progress || 0) > 70 }"
                    >
                    ...
                    <div v-if="!orders?.pending?.length" class="empty-state">
...
const emit = defineEmits(['openUpgrades', 'openResearch', 'openSpecialization', 'openSandbox', 'selectRoom', 'selectRegion']);
...
function purchaseRoom(key) {
    emit('selectRegion', key);
}
